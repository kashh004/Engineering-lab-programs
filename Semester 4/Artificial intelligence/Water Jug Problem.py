...
defdfs(curr_state, visited, jug1_capacity, jug2_capacity, target):
...
ifnew_state not in visited and dfs(new_state, visited, jug1_capacity, jug2_capacity, target):
print("Fill jug1")
return True
# Fill jug2
...
visited = set()
ifdfs(initial_state, visited, jug1_capacity, jug2_capacity, target):
